    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 mx-auto text-center mb-5">
          ...
          <p class="lead">If you&#39;re not satisfied, contact us within the first 30 days and we&#39;ll send you a full
            refund.</p>
        </div>
      </div>
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 my-auto">
              <div class="card-body text-center">
                ...
                <button type="button" class="btn move-on-hover bg-gradient-info btn-lg mt-2">Get Access</button>
